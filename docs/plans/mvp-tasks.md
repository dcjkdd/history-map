...
完成 CONTENT-00 只表示核对入口和首批清单已经建立，不表示历史内容已通过验收。`MVP-03` 仍然受人工资料与签字状态阻断。
...
- 12—20 个 Place
- 4—8 个 Geography Feature
- 10—15 个 Event
- 3—5 条逻辑路线、10—25 个 RouteSegment
- 2—3 个 Source
- 不少于 15 个 Citation
...
2. 至少包含长安、洛阳、陕州、灵宝、潼关，以及核心河流/山脉/通道关系。
